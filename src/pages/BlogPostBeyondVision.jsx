...
import fallbackImage from '../blogmain.jpeg';

const resolveBlogImage = (fileName) => {
  try {
...
const blogImage1 = resolveBlogImage('img_blog_1.JPG');
const blogImage2 = resolveBlogImage('img_blog_2.JPG');
const blogImage3 = resolveBlogImage('img_blog_3.JPG');
const blogImage4 = resolveBlogImage('img_blog_4.JPG');
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.35 }}>
      <section className="section-padding bg-white">
        <div className="container-custom max-w-4xl">
          ...
          <p className="text-xl text-gray-800 leading-relaxed mb-10 font-quicksand">
          ...
          <div className="mb-12 flex justify-center">
            <img
              src={blogImage1}
              alt="Discovery Day participants building trust through guided instruction"
          ...
          <p className="text-xl text-gray-800 leading-relaxed mb-6 font-quicksand">
            Some touched the ground first. Some explored the club. Some paused, listening deeply.
          </p>

          <p className="text-xl text-gray-800 leading-relaxed mb-10 font-quicksand">
            And then they struck. That moment, when they heard the ball roll and felt the connection, was not just a shot. It was belief taking shape.
          </p>

          <div className="mb-12 flex justify-center">
            <img
              src={blogImage2}
              alt="Participants learning golf through sound and touch"
              className="rounded-lg shadow-lg object-contain max-h-96 md:max-h-[28rem]"
            />
          </div>
          ...
          <p className="text-xl text-gray-800 leading-relaxed mb-10 font-quicksand">
            They were not just listening, they were picturizing every moment. Through sound, they were building the space in their minds.
          </p>
          ...
          <ul className="list-disc pl-8 text-xl text-gray-800 leading-relaxed mb-6 font-quicksand space-y-2">
          ...
          <div className="mb-12 flex justify-center">
            <img
              src={blogImage3}
              alt="Participants building confidence through guided swing practice"
              className="rounded-lg shadow-lg object-contain max-h-96 md:max-h-[28rem]"
            />
          </div>
          ...
          <ul className="list-disc pl-8 text-xl text-gray-800 leading-relaxed mb-6 font-quicksand space-y-2">
            ...
            <li>The joy of holding a golf ball and feeling its texture, its weight, its meaning</li>
          </ul>
          ...
          <div className="mb-12 flex justify-center">
            <img
              src={blogImage4}
              alt="Participants and volunteers concluding Discovery Day"
              className="rounded-lg shadow-lg object-contain max-h-96 md:max-h-[28rem]"
            />
          </div>
          ...
          <p className="text-xl text-gray-800 leading-relaxed mb-6 font-quicksand">
            When participants hear the ball, feel the strike, and trust the guidance, they do not need sight to believe.
          </p>
